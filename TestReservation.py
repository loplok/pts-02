...
class MyTestCase(unittest.TestCase):
    ...
    def test___init__(self):
        self.assertEquals(self.first_res._from, "1")
        self.assertEquals(self.first_res._to, "2")
        self.assertEquals(self.first_res._book, "book1")
        self.assertEquals(self.first_res._for, "user")
